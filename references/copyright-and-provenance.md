...
| `assets/brush-poses-v2/pose-01.png` through `pose-09.png` | OpenAI ImageGen outputs created 2026-08-21 from human-authored action specifications and project-owned AI-assisted references, then resized and chroma-keyed locally; exact source and published hashes in [`image-generation-record.md`](image-generation-record.md) | OpenAI assigns output rights to the user to the extent permitted by law; the selected sprites are published under MIT to the extent controlled and copyrightable, without claiming the depicted hand is a real contributor or identified person | Included |
...
| `assets/inkbrush-motion-demo.gif` | Direct capture of the live demo; exact source-file hashes, capture recipe, frame count, duration, and output hash are in [`readme-animation-record.md`](readme-animation-record.md) | MIT for the human-directed composition and captured rendition to the extent controlled and copyrightable, subject to the source-image boundaries in `COPYRIGHT.md` | Included |
...
| Playwright | [microsoft/playwright](https://github.com/microsoft/playwright) | [Apache License 2.0](https://github.com/microsoft/playwright/blob/main/LICENSE); maintainer capture tool only | Not included |
| FFmpeg 7.1 local build | [FFmpeg](https://ffmpeg.org/) | The local build reported GPL v2 or later because GPL components were enabled; see [FFmpeg Legal](https://ffmpeg.org/legal.html); maintainer conversion tool only | Not included |
