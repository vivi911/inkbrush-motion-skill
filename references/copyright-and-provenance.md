...
| `assets/inkbrush-motion-demo.gif` | Direct capture of the live demo at commit `d795bf817dcad6359f3428a53f4d43a223e15495`; exact capture record in [`readme-animation-record.md`](readme-animation-record.md) | MIT for the human-directed composition and captured rendition to the extent controlled and copyrightable, subject to the source-image boundaries in `COPYRIGHT.md` | Included |
