...
| imageio-ffmpeg 0.6.0 | ImageIO project; [0.6.0 package](https://pypi.org/project/imageio-ffmpeg/0.6.0/) and [tagged source](https://github.com/imageio/imageio-ffmpeg/tree/v0.6.0), accessed 2026-08-23 | [BSD-2-Clause](https://github.com/imageio/imageio-ffmpeg/blob/v0.6.0/LICENSE); the wrapper and its platform FFmpeg binary are maintainer-only. If redistributed, retain the applicable BSD notice and the executable's GPL materials | Not included; installed separately from `requirements-dev.txt` |
| FFmpeg 7.1 executable | FFmpeg project; [FFmpeg 7.1 source archive](https://ffmpeg.org/releases/ffmpeg-7.1.tar.xz) and [legal page](https://ffmpeg.org/legal.html), accessed 2026-08-23. The approved macOS arm64 executable came from imageio-ffmpeg 0.6.0, reports FFmpeg 7.1, was configured with `--enable-gpl --enable-libx264`, and has SHA-256 `6d175a4743ca50256e89a8cdd731100f9cee33bd79aeea46894d209410dc6617` | The selected combined executable reports [GPL version 2 or later](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html). No executable or FFmpeg source is redistributed here, so this repo adds no binary/source offer or notice bundle; encoded content is not claimed to inherit the tool's software license | Not included; maintainer/CI validation tool only |
